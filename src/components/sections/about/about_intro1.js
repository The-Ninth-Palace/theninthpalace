    ...
    <>
      <div class="neoh_fn_about_item">
        ...
        <div class="content_item">
          ...
          <div class="buttons">
							<a href="https://discord.gg/XB2z53vAmE" target="_blank" 
              rel="noreferrer"
              class="neoh_fn_button only_button">
								<span class="button">
							...
							<a href="https://theninthpalace.medium.com/" class="neoh_fn_button only_button" 
              rel='noreferrer'
              target="_blank">
